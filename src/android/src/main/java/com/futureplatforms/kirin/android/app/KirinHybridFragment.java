...
//
//abstract public class KirinHybridFragment<HybridModule extends HybridScreen<HybridNativeObject>, HybridNativeObject extends HybridScreenNative> extends KirinFragment<HybridModule, HybridNativeObject> implements HybridScreenNative
//{
...
//				if (url.equals(xurl)) getModule().onEntry();
//			}
//		});
//		
//		webView.loadUrl(url);
