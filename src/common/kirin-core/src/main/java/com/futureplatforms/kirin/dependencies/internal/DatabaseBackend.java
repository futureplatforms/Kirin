...
public interface DatabaseBackend {
	...
	public void open(String filename, DatabaseBackendCallback cb);
	public void beginTransaction(String dbId, String txId, DatabaseBackendTxCallback dbtc);
	public void appendSingleRowStatementToTransaction(String dbId, String txId, String sql, String[] params, DatabaseBackendTxCallback dbtc);
