...
import com.futureplatforms.kirin.gwt.compile.bindings.CSToNativeGenerator;
...
public class ToNativeBindingGenerator extends Generator {
    ...
    private final InterfaceGenerator[] mAppProtocolGenerators = {
            new CSToNativeGenerator("BINDINGS/windows/toNative/"),
    ...
    private final InterfaceGenerator[] mServiceProtocolGenerators = {
            new CSToNativeGenerator("SERVICE_BINDINGS/windows/toNative/"),
