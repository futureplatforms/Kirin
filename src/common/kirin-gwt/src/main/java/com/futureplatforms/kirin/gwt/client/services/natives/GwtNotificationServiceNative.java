...
public interface GwtNotificationServiceNative extends IKirinNativeService {
    void scheduleNotification(final int notificationId, final String timeMillisSince1970, final String title, final String text, int badge);
    void cancelNotification(final int notificationId);
}
