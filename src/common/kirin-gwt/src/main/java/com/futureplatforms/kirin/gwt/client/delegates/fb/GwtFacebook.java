...
import com.futureplatforms.kirin.gwt.client.services.fb.GwtFacebookService;
import com.futureplatforms.kirin.gwt.client.services.fb.GwtFacebookService.GwtFacebookCallback;
...
public class GwtFacebook extends FacebookDelegate {
	...
	@Override
	public void getAccessToken(AsyncCallback1<String> cb) {
	...
	public void uploadPhoto(String message, String image, AsyncCallback1<String> cb) {
		GwtFacebookService.BACKDOOR()._stageImage(message, image, cb);
	}
